...
SELECT name, governmentform AS "form_of_government" , headofstate AS "head_of_state"
FROM country
WHERE continent = 'Europe'
;
-- 4. The name, population, surface area, and average life expectancy of all countries in Asia (51 rows)
SELECT name, population, surfacearea AS "surface_area" , lifeexpectancy AS "avg_life_expectancy" 
FROM country
WHERE continent = 'Asia'
;
-- 5. The name, country code, and population of all cities with a population greater than 8 million people (10 rows)
SELECT name, countrycode AS "country_code", population
FROM city
...
SELECT name, continent, population, gnp, lifeexpectancy AS "avg_life_expectancy"
FROM country
...
SELECT name, continent, headofstate AS "head of state"
FROM country
...
SELECT name, continent, gnp, lifeexpectancy AS "avg_life_expectancy"
FROM country
...
SELECT name, 2021 - indepyear AS "years_since_independence"
FROM country
